...
{
    /// <summary>
    /// Interaction logic for ExtractorModelControl.xaml
    /// </summary>
    public partial class ExtractorModelControl : BaseControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtractorModelControl"/> class.
        /// </summary>
        public ExtractorModelControl()
        {
        ...
        public static readonly DependencyProperty SettingsProperty = DependencyProperty.Register(nameof(Settings), typeof(Settings), typeof(ExtractorModelControl), new PropertyMetadata<ExtractorModelControl>((c) => c.OnSettingsChanged()));
        public static readonly DependencyProperty IsSelectionValidProperty = DependencyProperty.Register(nameof(IsSelectionValid), typeof(bool), typeof(ExtractorModelControl));
        public static readonly DependencyProperty CurrentPipelineProperty = DependencyProperty.Register(nameof(CurrentPipeline), typeof(PipelineModel), typeof(ExtractorModelControl), new PropertyMetadata<ExtractorModelControl>((c) => c.OnPipelineChanged()));
        ...
        {
            ModelCollectionView = new ListCollectionView(Settings.ExtractorModels);
        ...
        private void Device_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                SelectedModel = ModelCollectionView.Cast<ExtractorModel>().FirstOrDefault(x => x == _currentModel || x.IsDefault);
            }
        }
        ...
        private Task OnPipelineChanged()
        {
            ...
            {
                SelectedModel = CurrentPipeline.ExtractorModel;
            }

            _currentDevice = CurrentPipeline?.Device;
            _currentModel = CurrentPipeline?.ExtractorModel;
        ...
        private async Task<bool> IsModelValidAsync()
        {
            ...
            return await _selectedModel.DownloadAsync(Path.Combine(Settings.DirectoryModel, "Extractor"));
        }
    }
}
