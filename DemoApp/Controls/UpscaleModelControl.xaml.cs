...
{
    /// <summary>
    /// Interaction logic for UpscaleModelControl.xaml
    /// </summary>
    public partial class UpscaleModelControl : BaseControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpscaleModelControl"/> class.
        /// </summary>
        public UpscaleModelControl()
        {
        ...
        public static readonly DependencyProperty SettingsProperty = DependencyProperty.Register(nameof(Settings), typeof(Settings), typeof(UpscaleModelControl), new PropertyMetadata<UpscaleModelControl>((c) => c.OnSettingsChanged()));
        public static readonly DependencyProperty IsSelectionValidProperty = DependencyProperty.Register(nameof(IsSelectionValid), typeof(bool), typeof(UpscaleModelControl));
        public static readonly DependencyProperty CurrentPipelineProperty = DependencyProperty.Register(nameof(CurrentPipeline), typeof(PipelineModel), typeof(UpscaleModelControl), new PropertyMetadata<UpscaleModelControl>((c) => c.OnPipelineChanged()));
        ...
        {
            ModelCollectionView = new ListCollectionView(Settings.UpscaleModels);
        ...
        private void Device_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                SelectedModel = ModelCollectionView.Cast<UpscaleModel>().FirstOrDefault(x => x == _currentModel || x.IsDefault);
            }
        }
        ...
        private Task OnPipelineChanged()
        {
            ...
            {
                SelectedModel = CurrentPipeline.UpscaleModel;
            }

            _currentDevice = CurrentPipeline?.Device;
            _currentModel = CurrentPipeline?.UpscaleModel;
        ...
        private async Task<bool> IsModelValidAsync()
        {
            ...
            return await _selectedModel.DownloadAsync(Path.Combine(Settings.DirectoryModel, "Upscale"));
        }
    }
}
