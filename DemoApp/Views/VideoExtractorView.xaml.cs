...
namespace DemoApp.Views
{
    ...
    public partial class VideoExtractorView : ViewBase
    {
        ...
        public VideoExtractorView(Settings settings, NavigationService navigationService, IHistoryService historyService, IExtractorService extractorService)
        ...
        private async Task ExecuteAsync()
        {
            ...
            try
            {
                ...
                // Save History
                var savedStream = await HistoryService.AddAsync(resultVideo, new ExtractorItem
                {
                    Source = View.VideoExtractor,
